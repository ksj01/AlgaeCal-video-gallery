...
class InMemoryVideoRepositoryTest extends TestCase
{
    public function testFindAll()
    {
        ...
        $this->assertEquals([$video], $videoRepository->findAll());
    }

    public function testFindAllVideosByDefault()
    {
        $videos = [
        ...
        $this->assertEquals(array_values($videos), $videoRepository->findAll());
    }
